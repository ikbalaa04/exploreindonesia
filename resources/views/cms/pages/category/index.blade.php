...
@section('title','Dashboard admin Categories')
@section('content')
    ...
    <div class="row">
        <div class="col">
            <div class="page-description">
                <h1>category</h1>
                <span>List category, yang akan ditampilkan dihalaman depan</span>
                <br>
                <a href="{{ route('masterData.category.create') }}?type=add" class="">
                    <i class="fa-solid fa-circle-plus fa-2xl" style="color: #02c061;"> <span style="font-size: 14px">Add category</span></i>
                </a>
            </div>
            @if(session('failed'))
        ...
        $(document).ready(function() {
            var table = $('#category').DataTable({
                ...
                'columns': [
                    ...
                    // {data: 'subCategory', name: 'subCategory', orderable:false, searching:false},
