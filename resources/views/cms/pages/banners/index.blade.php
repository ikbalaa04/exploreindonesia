...
@section('title','Dashboard admin banners')
@section('content')
    ...
    <div class="row">
        <div class="col">
            <div class="page-description">
                <h1>Banner</h1>
                <span>List banner, yang akan ditampilkan dihalaman depan</span>
                <br>
                <a href="{{ route('websiteManagement.banner.create') }}?type=add" class="">
                    <i class="fa-solid fa-circle-plus fa-2xl" style="color: #02c061;"> <span style="font-size: 14px">Add Banner</span></i>
                </a>
            </div>
            @if(session('failed'))
            ...
            <div class="card">
                <div class="card-body">
                    <table id="banner" class="display nowrap" style="width:100%">
                        <thead>
                            <tr>
                                <th>No.</th>
                                <th>Action</th>
        ...
        $(document).ready(function() {
            var table = $('#banner').DataTable({
                "initComplete": function (settings, json) {  
                    $("#banner").wrap("<div style='overflow:auto; width:100%;position:relative;'></div>");            
                },
                'processing' : true,
                'deferRender'  : true,
                'dom': 'Bfrtip',
                ...
                'columns': [
                    ...
                    {data: 'banner_file', name: 'banner_file', orderable:false, searching:false},
            ...
            $('#deletePermanent_button').click(function(){
                ...
                $.ajax({
                    type: 'POST',
                    url:'/website-management/banner/'+idhapus,
                    data:{
                        'id': idhapus,
                        '_method': 'DELETE',
                        '_token': '{{ csrf_token() }}',
